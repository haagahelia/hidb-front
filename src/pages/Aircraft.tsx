...
const Aircraft = () => {
  ...
  const types = ["Commercial", "Military", "Regional"];
  ...
  const filteredAircraft = aircraftData.filter((aircraft) => {
    ...
    const matchesType =
      selectedType === "all" || aircraft.aircraft_type === selectedType;
        ...
        <div className="container mx-auto px-4 flex flex-col flex-1">
          ...
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Explore our extensive collection of historic aircraft from various
              eras and nations
            </p>
          </div>
                ...
                <Card className="h-full hover-lift aircraft-shadow border-border overflow-hidden group">
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <Badge className="absolute top-4 right-4 gradient-sky">
                      {getTypeLabel(aircraft.aircraft_type)}
                    </Badge>
