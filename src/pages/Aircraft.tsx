...
const Aircraft = () => {
    ...
    const types = ["all", "Fighter Jet", "Fighter Aircraft", "Transport Aircraft"];
    ...
    const filteredAircraft = aircraftData.filter((aircraft) => {
        const matchesSearch =
            ...
            aircraft.role.toLowerCase().includes(searchTerm.toLowerCase());
                            ...
                            >
                                <Card className="h-full hover-lift aircraft-shadow border-border overflow-hidden group">
                                    <div className="relative h-64 overflow-hidden">
                                        ...
                                        <Badge className="absolute top-4 right-4 gradient-sky">{aircraft.type}</Badge>
                                    </div>
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                            <Badge variant="outline">{aircraft.role}</Badge>
                                        </div>
                                    </CardContent>
                                </Card>
                            </Link>
