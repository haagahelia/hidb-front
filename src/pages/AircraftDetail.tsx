        ...
        <div className="min-h-screen bg-background relative">
            ...
            <div className="pt-24 pb-16 relative z-10">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <Link to="/aircraft" className="inline-block mb-6">
                    ...
                    {/* Header Image */}
                    <motion.div
                        className="relative h-96 rounded-xl overflow-hidden mb-8 aircraft-shadow"
                    ...
                    <div className="grid lg:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <motion.div
                                ...
                                transition={{duration: 0.6, delay: 0.3}}
                            >
                                <QRCodeDisplay aircraftId={aircraft.id} aircraftName={aircraft.name} size="lg" />
                            </motion.div>
